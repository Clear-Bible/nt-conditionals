...
<br/>p: (but/except the one whom I have pained?)
...
<br/>p: (whether you are obedient in everything)
...
## Notes
εἰ introduces a question that is a dependent clause (the main clause has the verb 'know', so εἰ is functioning grammatically as a complementizer).
...
<br/>q: (a veil lies over their hearts)
...
## Notes
Verses 15 and 16 should be considered together. While v.15 contains the particle αν and v.16 contains the particle εαν, each has ηνικα "when" functioning together with the conditional particle to create a "whenever" sense in English.
...
## Notes
Verse 16 echos Exodus 34:34, that whenever Moses went in to meet with the LORD, he removed the veil. Paul is now applying this metaphorical idea of a veil to the Israelites (and all) who come to beleive in Christ and repent.
...
<br/>p v.3: (if indeed, by putting it on we may not be found naked)
...
## Notes
There is a wide range of translations of the phrase εἴ γε καὶ, indicating a lack of consensus on how it is excactly being used. There does not appear to be a clear conditional relationship between p and q.
...
<br/>q: (we make it our aim to please him)
...
## Notes
εἴτε 'whether... or' appears before each item in the list
...
## Notes
The Greek phrase καθὸ ἐὰν has the sense of "according to"
...
## Notes
εἴτε 'whether... or' appears before 'Titus' and 'our brothers'
...
## Notes
εἴτε 'whether... or' appears before "in the body" and "out of the body".
...
## Notes
εἰ introduces a question that is a dependent clause (the main clause has the verb πειράζετε 'test' in Greek and 'see' in English, so εἰ is functioning grammatically as a complementizer).
...
<br/>p: (but there are some who trouble you and want to distort the gospel of Christ)
...
<br/>p: (except James that Lord's brother)
...
<br/>p: (but through faith in Jesus Christ)
...
<br/>p: (except in the cross of Jesus our Lord)
...
## English
NASB:
<br/>p: (if indeed you have heard of the stewardship of God’s grace which was given to me for you...)
...
Some commentators (Hoehner 2008; Arnold 2010) suggest that p consists of vs.2-12, and q is v.13. However, most translations do not treat this as a genuine conditional; Translator's Notes accepts the NIV's "surely" and states, "Paul was saying that he was sure that the Ephesian believers knew of his ministry of preaching the gospel."
...
<br/>q: (in saying, 'He ascended,' what does it mean...)
...
<br/>p: (but only such as is good for building up)
...
<br/>p: (whether he is a bondservant or is free)
...
## Notes
εἴτε appears before 'slave' and 'freeman'
...
<br/>p: (whether by life or by death)
...
<br/>q: (I may hear of you that you are standing firm in one spirit, with one mind striving side by side for faith of the gospel)
...
## Notes
Greek: ει πως + subjunctive ('if somehow I may')

The conditional is not "If I atttain resurrection from the dead" but "If there are any means possible by which I can attain resurrection of the dead" the latter which we know to be true. Thus Paul is not arguing that he has for certain gained resurrection from the dead, but that since it is a possibility he will do anything and everything to attain it.
...
## Notes
Greek εἰ καὶ 'even if, if indeed'

"it" refers to the righteousness which Paul talks about in 3:8-11, that he is working towards but has not yet attained.
...
<br/>q: (all things were created through him and for him)
...
<br/>p: (whether on earth or in heaven)
...
## Notes
εἴτε appears before "things on earth" and "things in the heavens"
...
<br/>q: (do everything in the name of the Lord Jesus, giving thanks to God the Father through him)
...
## English
p: (whatever you do)
<br/>q: (work heartily, as for the Lord and not for men)
...
## English
ESV:
<br/>q: (but we were gentle among you)
<br/>p: (like a nursing mother taking care of her own children)
<br/>
<br/>NIV:
<br/>p: (just as a nursing mother cares for her children)
<br/>q (v.8): (so we cared for you)
...
<br/>q: ([Jesus] died for us so that ... we might live with him)
...
The conditionals "if we are awake or if we are asleep..." state that being alive or asleep (i.e. dead) makes no difference; we will live with him in either case. This can be expressed in English as 'whether we are alive or asleep/dead' or 'even if we are alive and even if we are asleep, we will live with him.'

This is an ‘alternative concessive conditional’ construction, in which the two 'conditional' clauses present an exhaustive set of alternatives, in this case being alive or being dead.
...
<br/>p: (since indeed God considers it just to repay with affliction those who afflict you, and to grant relief to you who are afflicted as well as to us)
...
<br/>p: (...either by our spoken word or by our letter)
...
## Notes
εἴτε appears before 'word' and 'letter'
...
<br/>p: (and whatever else is contrary to sound doctrine)
...
## Notes
Greek: εἴ τι ἕτερον 'if any other thing'. This does not state a condition under which q holds, but rather ει τι functions as an indefinite pronoun. Similar to 2Co 2:10, 7:14.
...
## English
NASB (following Greek closely):
<br/>p1: (if anyone competes as an athlete,)
<br/>q1: (q2: [he does not win the prize] p2: [unless he competes according to the rules.])
<br/>
<br/>ESV: 
<br/>q: (An athlete is not crowned)
<br/>p: (unless he competes according to the rules)
...
## Notes
This verse is grammatically complex because it has a conditional embedded within another conditional. Most translations simplify the grammar in some way. The first p seems to be presentational, introducing the topic of athletes, so in that sense, 2:5b-c is the true conditional (see ESV).

Paraphrase (to avoid multiple negatives in languages without 'unless'):

p1 (if anyone competes as an athlete,) q1: (q2: [he wins the prize] p2: [only if he competes according to the rules.])

or:

q: (an athlete wins the prize) p: [only if he competes according to the rules.)
...
<br/>q: (we will also live with him)
...
## Notes
The conditionals of 2:11-13 are a Christian hymn modified by Paul for this context, rather than a logical argument .

2Ti 2:11 is very similar to Rom 6:8. Given the connection with baptism in Romans 6, Paul's theology, and the fact that this p is in the aorist, this is clearly a factual conditional.
...
## English
p: (if we endure,)
<br/>q: (we will also reign with him)
...
## Notes
Mounce (2000) claims that there is an implied warning in this verse. Unlike v.11, the final three conditionals in this hymn have a neutral probability.
...
## Notes
Mounce (2000) claims that 2:12b refers to total apostasy whereas 2:13 refers to temporary disobedience.
...
Q is true regardless of the validity of p, so this could be interpreted as a concessive condtional: "even if we are are unfaithful, he remains faithful."
...
<br/>q: (he will be a vessel for honorable use, set apart as holy, useful to the master of the house, ready for every good work.)
...
## Notes
This conditional introduces the topic of people who are cleansed from moral wrong.
...
<br/>q: (IMPLIED: appoint such a person)
...
## Notes
Paul is giving Titus a guideline for appointing elders. This conditional lists the attributes of an elder; however, q is left implicit. The conditional expression εἴ τίς 'if anyone' can equally well be treated as an indefinite pronoun as in NRSV "someone".
...
<br/>q: (receive him as you would receive me)
...
## Notes
Philemon knows that Paul considers him a partner. Paul is making his request on the basis of that relationship.
...
<br/>q: (charge that to my account)
...
## Notes
Paul is sending Onesimus, a slave, back to Philemon, his master. It is highly likely that Philemon feels that Onesimus has done him wrong. By asking Philemon to charge everything owed to his (Paul's) account, Paul is taking on the responsibility for paying what Onesimus owes.
...
## Notes
εἰ has the force of an emphatic negative. There is no q; this may be a Hebraism (Elliot).
...
<br/>p: (but to those who were disobedient?)
...
## Notes
Εἰ μὴν has the force of 'surely'. There is no q; this may be a Hebraism (Elliot).
...
<br/>q: (makes himself an enemy of God)
...
<br/>q: (be subject for the Lord's sake to every human institution)
...
## English
q: (who is the liar)
<br/>p: (but he who denies that Jesus is the Christ)
...
<br/>p: (when he appears)
<br/>q: (we may have confidence and not shrink from him in shame at his coming)
...
## Notes
Greek: ἐὰν. BDAG cites this verse under definition 2 of ἐὰν, glossed as "whenever, when."
...
but we know that 
<br/>p: (when he appears)
<br/>q: (we shall be like him because we shall see him as he is)
...
<br/>p: (whether they are from God)
...
## Notes
This is an indirect question, not a conditional. The εἰ clause is not paired with another clause whose validity depends on that of the εἰ clause. See BDAG definition 5bα of εἰ.
...
## English
p: (Whoever confesses that Jesus is the Son of God)
<br/>q: (God abides in him, and he in God)
<br/>
<br/>NIV:
<br/>p: (If anyone acknowledges that Jesus is the Son of God,)
<br/>q:(God lives in them and they in God)
...
<br/>p: (except the one who believes that Jesus is the Son of God?)
...
<br/>p: ([in] whatever you do for the brethren).
...
<br/>p: (except the one who receives it)
...
## Notes
Greek: ὅσους ἐὰν 'as much/many as'
...
<br/>p: (but only those people who do not have the seal of God on their foreheads)
...
## Notes
Greek: ὁσάκις ἐὰν 'whenever', 'as often as'
...
<br/>q: (those who would not worship the image of the beast to be slain)
...
<br/>p: (except the 144,000 who had been redeemed from the earth)
...
<br/>p: (and whoever receives the mark of its name)
...
## Notes
Greek: εἴ τις 'if anyone' but here the sense is 'whoever' or 'those who'
...
<br/>p: (but only those who are written in the Lamb's book of life)
